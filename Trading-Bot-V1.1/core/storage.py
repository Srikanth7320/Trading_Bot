...
from core.market_clock import ist_today
...
class Storage:
    ...
    def _write_json(self, path: Path, payload: Any) -> None:
        """Replace JSON files atomically so dashboard reads never see partial data."""
    ...
    def add_cooldown(self, symbol: str, days: int) -> None:
        ...
        cooldowns[symbol] = (ist_today() + timedelta(days=days)).isoformat()
